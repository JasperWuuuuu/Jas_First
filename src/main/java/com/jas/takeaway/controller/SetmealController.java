...
public class SetmealController {
     ...
     */
    @PostMapping
    @CacheEvict(value = "setmealCache",allEntries = true) //清理當前分類下所有的緩存數據
    ...
    public R<Page> page(int page,int pageSize,String name){
        ...
        Page<SetmealDto> dtoPage = new Page<>(); //其中就有categoryName屬性
    ...
    public R<List<Setmeal>> list(Setmeal setmeal){ //前端傳的參數是鍵值對，不是JSON，不需要RequestBody
        LambdaQueryWrapper<Setmeal> queryWrapper = new LambdaQueryWrapper<>();
